...
namespace Braesident\Blowfish;

\define('CBC', 1);

/**
 * PHP implementation of Blowfish (www.php-einfach.de) packaged as a class.
 *
...
final class blowfish
{
  ...
  private function block_encrypt($v0, $v1)
  {
    if ($v0 < 0) {
      $v0 += 4294967296;
    }
  ...
  private function block_decrypt($v0, $v1)
  {
    if ($v0 < 0) {
      $v0 += 4294967296;
    }
